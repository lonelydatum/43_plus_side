...
var _commonJsPlusHelperJs = require('../../_common/js/plusHelper.js');
...
window.plusSettings = {
    ...
    "300x250": {
        br: { DYANAMIC: 2, NEW_SPORTS: null, SINGLE: 3, NEW_WAY: null }
    },
    "300x600": {
...
function initCommon(sports) {
    ...
    _config = config;
    var msg2 = (0, _commonJsPlusHelperJs.addBR)(config, config.msg2);
    var msg3 = (0, _commonJsPlusHelperJs.addBR)(config, config.msg3);

    document.getElementById("t2").innerHTML = msg2;
    document.getElementById("t3").innerHTML = msg3;
    document.getElementById("bonus").innerHTML = "$" + _commonJsPlusHelperJs.TXT[config.bonus] + " BONUS";
    ...
    tl.add((0, _commonJsPlusHelperJs.textFX)("#t1a"), "+=.1");
    ...
    tl.add((0, _commonJsPlusHelperJs.textFX)("#t1b"), "playa");
    ...
    // return
    tl.add("t2", "+=.2");
    tl.add((0, _commonJsPlusHelperJs.textFX)("#t2"), "t2");
    tl.add(function () {
        TweenMax.to('.star', { duration: 1, opacity: 1, yoyo: true, repeat: 1 });
    }, "t2");
    tl.to("#t2", { duration: .3, opacity: 0 }, "+=" + _commonJsPlusHelperJs.TXT[_config.msg2].read);

    tl.add("t3");
    tl.add((0, _commonJsPlusHelperJs.textFX)("#t3"), "t3");
    tl.add(function () {
        TweenMax.to('.star', { duration: 1, opacity: 1, yoyo: true, repeat: 1 });
    }, "t3");
...
function endBB(tl) {
    tl.to(["#t3"], { duration: .2, opacity: 0 }, "+=" + _commonJsPlusHelperJs.TXT[_config.msg3].read);
    showBonus(tl);
    if (plusData.bonus > 0) {
...
function showBonus(tl) {
    ...
    if (plusData.bonus > 0) {
        ...
        tl.add((0, _commonJsPlusHelperJs.textFX)("#bonus", .04), "+=.1");
    }
    return tl;
}
...
function endFooter(tl) {
    ...
    tl.add((0, _commonJsPlusHelperJs.olg)(), "footer");
    tl.add(function () {
...
function playa(sportItem) {
    ...
    sportItem.flares.map(function (item, i) {
        tl.add(function () {
            (0, _commonJsPlusHelperJs.flare)(".flare" + (i + 1));
        }, "+=" + i / sportItem.flares.length * .6);
    });
}
